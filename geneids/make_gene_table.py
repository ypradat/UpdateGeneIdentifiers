...
Functions for making correspondence tables between gene identifiers from different file formats.
...
def make_gene_table(df: DataFrame, fields_ids: list, fields_dup: list=None, save_folder: str=None,
                    save_all_fields_ids: bool=True, save_per_field_dup: bool=False) -> DataFrame:
    """
